...
class DrugEncoder(torch.nn.Module):
    def __init__(self, num_node_features, num_hidden, num_emb):
        ...
        self.conv2 = GCNConv(num_hidden, num_emb)
...
#     emb_dim, num_heads, dropout, is_attention, is_cmap
    ...
    batch_size = trial.suggest_categorical("batch_size", [10, 25, 50,])
...
study = optuna.create_study(
    ...
    storage="sqlite:///cmap_GCNConv.sqlite3",
    study_name="cmap_GCNConv",
    load_if_exists=True,
)
